...
typedef int bool_t;
    ...
    (defined(__linux__) && !defined(__GLIBC_MINOR__))
...
#define XDR_RNDUP(x)                                                           \
  (((x) + BYTES_PER_XDR_UNIT - 1) & ~(BYTES_PER_XDR_UNIT - 1))
...
struct xdr_ops {
  ...
  bool_t (*x_setpostn)(XDR *__xdrs, off_t __pos);
...
extern bool_t xdr_int_check(XDR *__xdrs, int *__ip);
...
extern bool_t xdrstdio_getbytes(XDR *, char *, unsigned int);
extern bool_t xdrstdio_putbytes(XDR *, char *, unsigned int);
extern off_t xdrstdio_getpos(XDR *);
extern bool_t xdrstdio_setpos(XDR *, off_t);
extern xdr_int32_t *xdrstdio_inline(XDR *, int);
extern void xdrstdio_destroy(XDR *);
extern bool_t xdrstdio_getint32(XDR *, xdr_int32_t *);
extern bool_t xdrstdio_putint32(XDR *, xdr_int32_t *);
extern bool_t xdrstdio_getuint32(XDR *, xdr_uint32_t *);
extern bool_t xdrstdio_putuint32(XDR *, xdr_uint32_t *);
